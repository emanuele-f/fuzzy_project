...
void fuzzy_area_iter_begin(FuzzyArea * area, FuzzyAreaIterator * iterator, const FuzzyPoint * pivot, const FuzzyPoint * limit)
{
...
FuzzyAreaIterator * fuzzy_area_iter(FuzzyArea * area, FuzzyAreaIterator * iterator)
{
    ulong locx, locy;
...
bool fuzzy_area_inside(FuzzyArea * area, const FuzzyPoint * pivot, const FuzzyPoint * check)
{
    ulong locx, locy;
